package com.assu.app.presentation.user.location.adapter
...
import com.assu.app.data.dto.location.LocationSearchItem
import com.assu.app.databinding.ItemLocationSearchRankBinding

class UserLocationSearchRankAdapter(
    private val items: List<LocationSearchItem>
) : RecyclerView.Adapter<UserLocationSearchRankAdapter.ViewHolder>() {
