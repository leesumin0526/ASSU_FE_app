package com.assu.app.presentation.partner.home
...
import com.assu.app.databinding.ActivityPartnerHomeViewAdminListBinding
import com.assu.app.domain.model.admin.GetProposalAdminListModel
import com.assu.app.presentation.base.BaseActivity
import com.assu.app.presentation.partner.home.adapter.PartnerAdminListAdapter
        ...
        lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                partnershipViewModel.getPartnershipAdminListUiState.collect { state ->
                    when (state) {
                        is com.assu.app.ui.partnership.PartnershipViewModel.PartnershipAdminListUiState.Success -> {
                            updateList(state.data)
                        }
                        is com.assu.app.ui.partnership.PartnershipViewModel.PartnershipAdminListUiState.Fail -> {
                            // TODO: 에러 처리 (토스트 등)
                        }
                        is com.assu.app.ui.partnership.PartnershipViewModel.PartnershipAdminListUiState.Error -> {
                            // TODO: 에러 처리
                        }
                        else -> Unit
                    }
