...
import com.assu.app.QrSaveFragment
...
import com.assu.app.databinding.FragmentProposalModifyBinding
            ...
            when (item) {
                is PartnershipContractItem.Service.ByPeople -> {
                    BenefitItem(
                        ...
                        optionType = com.assu.app.data.dto.partnership.OptionType.SERVICE,
                        criterionType = com.assu.app.data.dto.partnership.CriterionType.HEADCOUNT,
                ...
                is PartnershipContractItem.Service.ByAmount -> {
                    BenefitItem(
                        id = System.currentTimeMillis().toString(),
                        optionType = com.assu.app.data.dto.partnership.OptionType.SERVICE,
                        criterionType = com.assu.app.data.dto.partnership.CriterionType.PRICE,
                ...
                is PartnershipContractItem.Discount.ByPeople -> {
                    BenefitItem(
                        id = System.currentTimeMillis().toString(),
                        optionType = com.assu.app.data.dto.partnership.OptionType.DISCOUNT,
                        criterionType = com.assu.app.data.dto.partnership.CriterionType.HEADCOUNT,
                        criterionValue = item.minPeople.toString(),
                        category = "",
                        goods = emptyList(),
