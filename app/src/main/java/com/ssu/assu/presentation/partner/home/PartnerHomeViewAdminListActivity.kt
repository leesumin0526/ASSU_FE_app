...
import com.ssu.assu.databinding.ActivityPartnerHomeViewAdminListBinding
import com.ssu.assu.domain.model.admin.GetProposalAdminListModel
import com.ssu.assu.presentation.base.BaseActivity
import com.ssu.assu.presentation.partner.home.adapter.PartnerAdminListAdapter
        ...
        lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                partnershipViewModel.getPartnershipAdminListUiState.collect { state ->
                    when (state) {
                        is com.ssu.assu.ui.partnership.PartnershipViewModel.PartnershipAdminListUiState.Success -> {
                            updateList(state.data)
                        }
                        is com.ssu.assu.ui.partnership.PartnershipViewModel.PartnershipAdminListUiState.Fail -> {
                            // TODO: 에러 처리 (토스트 등)
                        }
                        is com.ssu.assu.ui.partnership.PartnershipViewModel.PartnershipAdminListUiState.Error -> {
                            // TODO: 에러 처리
                        }
                        else -> Unit
                    }
