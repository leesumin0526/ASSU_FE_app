...
import com.ssu.assu.databinding.ItemAssociationListBinding
...
class AdminPartnerListAdapter(
    ...
    private fun mapOptionToContractItem(opt: com.ssu.assu.domain.model.partnership.PartnershipOptionModel)
