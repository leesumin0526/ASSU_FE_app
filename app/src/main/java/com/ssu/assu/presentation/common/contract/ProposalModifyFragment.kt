package com.ssu.assu.presentation.common.contract
...
import com.ssu.assu.QrSaveFragment
...
import com.ssu.assu.databinding.FragmentProposalModifyBinding
...
import com.ssu.assu.presentation.common.chatting.proposal.adapter.ProposalModifyAdapter
            ...
            when (item) {
                is PartnershipContractItem.Service.ByPeople -> {
                    BenefitItem(
                        ...
                        optionType = com.ssu.assu.data.dto.partnership.OptionType.SERVICE,
                        criterionType = com.ssu.assu.data.dto.partnership.CriterionType.HEADCOUNT,
                ...
                is PartnershipContractItem.Service.ByAmount -> {
                    BenefitItem(
                        id = System.currentTimeMillis().toString(),
                        optionType = com.ssu.assu.data.dto.partnership.OptionType.SERVICE,
                        criterionType = com.ssu.assu.data.dto.partnership.CriterionType.PRICE,
                ...
                is PartnershipContractItem.Discount.ByPeople -> {
                    BenefitItem(
                        id = System.currentTimeMillis().toString(),
                        optionType = com.ssu.assu.data.dto.partnership.OptionType.DISCOUNT,
                        criterionType = com.ssu.assu.data.dto.partnership.CriterionType.HEADCOUNT,
                        criterionValue = item.minPeople.toString(),
                        category = "",
                        goods = emptyList(),
